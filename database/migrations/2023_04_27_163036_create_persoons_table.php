...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('persoons', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('familie1ID')->default(null)->nullable();
            $table->unsignedBigInteger('familie2ID')->default(null)->nullable();
            ...
            $table->date('gestrovenop')->default(null)->nullable();
